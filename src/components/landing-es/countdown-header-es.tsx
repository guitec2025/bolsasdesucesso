...
export function CountdownHeaderES() {
  ...
  useEffect(() => {
    ...
    const calculateTimeLeft = () => {
      const now = new Date();
      // Mês 7 no JavaScript é Agosto (0-indexed: 0=Jan, 7=Ago)
      // Definido para 17 de Agosto de 2026
      const targetDate = new Date(2026, 7, 17, 23, 59, 59);
    ...
    return (
      <div className="bg-background py-3 border-b border-border/10 min-h-[80px]">
        <div className="container mx-auto flex items-center justify-center px-4">
           <p className="text-foreground/90 font-body text-base sm:text-lg">Cargando...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-background py-3 border-b border-border/10">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 px-4">
        <p className="text-foreground/90 font-body text-base sm:text-lg text-center md:text-left">
          Inscripciones abiertas hasta el <b>17 de agosto</b>
        </p>

...
export function GuaranteeES() {
  const guaranteeText = `Tienes <b>30 días</b> para explorar el contenido del curso, la comunidad y los bonos. Si por cualquier motivo sientes que no es para ti, solo envíanos un correo y te devolveremos el <b>100% del valor sin burocracia</b>. Tu satisfacción es nuestra prioridad.`;
